...
interface ChatInputProps {
  ...
  setChat: (value: string | ((old: string) => string | null) | null, options?: Options) => Promise<URLSearchParams>
}

export function StartChat ({handleSubmit, isLoading, input, setInput, files, setFiles, setChat, stop, fileInputRef}: ChatInputProps) {
  ...
  return (
    <div className="flex flex-col">
      <h1 className="text-3xl font-semibold text-center mb-6">What's on your mind?</h1>
      ...
      >
        ...
        >
            ...
            {isLoading ? (
                <Button size="sm"
            className="h-9 w-9 rounded-full" onClick={stop}>
